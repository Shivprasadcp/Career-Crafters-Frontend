...
//       alert('Failed to download career assessment report. Please try again.');
//     } finally {
//       setIsLoading(false);
//     }
//   };
...
//       pdf.text(`Name: ${report.executive_summary.name}`, 30, yPos);
//       yPos += 7;
//       pdf.text(`Age: ${report.executive_summary.age}`, 30, yPos);
//       yPos += 7;
//       pdf.text(`Education: ${report.executive_summary.education}`, 30, yPos);
//       yPos += 7;
//       pdf.text(`Career Aspiration: ${report.executive_summary.career_aspiration}`, 30, yPos);
//       yPos += 10;

//       // Key findings with word wrap
//       pdf.setFontSize(12);
//       pdf.setTextColor(60, 60, 60);
//       const splitKeyFindings = pdf.splitTextToSize(report.executive_summary.key_findings, 160);
...
//       pdf.setFontSize(12);
//       pdf.setTextColor(0, 0, 0);
//       pdf.text(`MBTI Type: ${report.personality_analysis.mbti_type}`, 30, yPos);
//       yPos += 7;

//       const splitPersonalityAnalysis = pdf.splitTextToSize(report.personality_analysis.analysis, 160);
...
//       pdf.setFontSize(12);
//       pdf.setTextColor(0, 0, 0);
//       pdf.text(`Top Aptitudes: ${report.aptitude_analysis.aptitude_test_results.join(", ")}`, 30, yPos);
//       yPos += 7;

//       const splitAptitudeAnalysis = pdf.splitTextToSize(report.aptitude_analysis.analysis, 160);
...
//       pdf.setFontSize(12);
//       pdf.setTextColor(0, 0, 0);
//       pdf.text(`Aspiration Alignment: ${report.alignment_analysis.aspiration_alignment}`, 30, yPos);
//       yPos += 7;

//       const splitAlignmentAnalysis = pdf.splitTextToSize(report.alignment_analysis.analysis, 160);
...
//       pdf.setFontSize(12);
//       pdf.setTextColor(0, 0, 0);
//       pdf.text(`Weaknesses: ${report.weakness_development.weaknesses.join(", ")}`, 30, yPos);
//       yPos += 10;

//       pdf.text("Improvement Strategies:", 30, yPos);
//       yPos += 7;

//       report.weakness_development.strategies.forEach((strategy, index) => {
...
//       report.recommended_career_paths.forEach((career, index) => {
//         pdf.setFontSize(12);
//         pdf.setTextColor(0, 0, 0);
//         pdf.text(`${index + 1}. ${career.career}`, 30, yPos);
//         yPos += 7;

//         pdf.setFontSize(10);
//         pdf.setTextColor(80, 80, 80);
//         const splitRationale = pdf.splitTextToSize(`Rationale: ${career.rationale}`, 150);
...
//       report.development_roadmap.steps.forEach((step) => {
//         pdf.setFontSize(12);
//         pdf.setTextColor(0, 0, 0);
...
//         pdf.setFontSize(10);
//         pdf.setTextColor(80, 80, 80);
//         const splitAction = pdf.splitTextToSize(step.action, 150);
...
//       report.alternative_paths.forEach((career, index) => {
//         pdf.setFontSize(12);
//         pdf.setTextColor(0, 0, 0);
//         pdf.text(`${index + 1}. ${career.career}`, 30, yPos);
//         yPos += 7;
  ...
  const generatePDF = (data) => {
    try {
      ...
      if (report.executive_summary) {
        ...
        pdf.text(`Name: ${summary.name || 'N/A'}`, 30, yPos);
        yPos += 7;
