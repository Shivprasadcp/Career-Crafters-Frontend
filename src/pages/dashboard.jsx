...
//   console.log("username:", userData.success);
...
//     try {
//       console.log("Aptitude:", userData.id);
...
//       // Wait until questions are set
//       setTimeout(() => {
//         navigate('/assesment');
//         // alert('New assessment started successfully!');
//       }, 100);
//     } catch (error) {
//       console.error('Error starting new assessment:', error);
//       // alert('Failed to start a new assessment.');
//     }
//   };
...
//     try {
//       console.log("Likert :", userData.user_id); // Use user_id instead of id based on your console logs
      
//       // Use the get_questions endpoint we already created
//       const response = await axios.post('http://127.0.0.1:8000/tests/likert_test/get_questions/', {
//         userId: userData.id,
//         top_domains: topDomains
//       });
  
//       console.log('Likert test started:', response.data);
  
//       // Store the questions in localStorage to access them on the likert page
//       localStorage.setItem('likertQuestions', JSON.stringify(response.data.questions));
  
//       navigate('/likerttest');
//     } catch (error) {
//       console.error('Error starting Likert test:', error);
//       alert('Failed to start Likert test.');
//     }
//   };
...
//               <li>Explore</li>
//               <li>Path</li>
//               <li className='border rounded-full bg-blue-400 p-1 text-white'><img src={Logo} alt="" width={10} height={10} /></li>
//             </ul>
//           </div>
//         </div>
...
//               <div className='bg-[#F0F2F3] p-2 rounded-lg' onClick={handleLogout}>Logout</div>
//             </div>
//           </div> */}
//           <div className='h-3/4'>
//             <div className='flex flex-col justify-evenly gap-4'>
//               <div className='hover:bg-[#F0F2F3] p-2 rounded-lg'>Dashboard</div>
//               <div className='hover:bg-[#F0F2F3] p-2 rounded-lg'>Assessments</div>
//               <div className='hover:bg-[#F0F2F3] p-2 rounded-lg'>Explore</div>
//               <div className='hover:bg-[#F0F2F3] p-2 rounded-lg'>Connect AI Counselor</div>
//               <div
...
//           <div className='h-1/4'>
//             <div
//               className='bg-[#1A80E6] p-2 rounded-lg text-center text-white cursor-pointer'
...
//           </div>
//           <div className='w-1/2 border-2 mt-4 rounded-lg border-[#E0E0E0] p-4 shadow-sm bg-white'>
...
//             <div
//               className='w-1/2 bg-[#1A80E6] p-2 rounded-lg text-center text-white cursor-pointer'
//               onClick={startNewAssessment}
//             >
//               New assessment
//             </div>
//             <div
//               className='w-1/2 bg-[#5e8b36] p-2 rounded-lg text-center text-white cursor-pointer'
//               onClick={startLikertTest}
//             >
//               Take Likert Test
//             </div>
//             <div className='w-1/2 bg-[#F0F3F3] p-2 rounded-lg text-center text-black'>
//               Get started with AI career counsellor
//             </div>
//           </div>
//         </div>
//       </div>
...
//   const startLikertTest = async () => {
//     try {
//       console.log("Likert test for user:", userData.user_id);
      
//       // Use the get_questions endpoint to fetch Likert questions
//       const response = await axios.post('http://127.0.0.1:8000/tests/likert_test/get_questions/', {
...
//       // Store questions in Redux instead of localStorage
//       dispatch(setLikertQuestions(response.data.questions));
